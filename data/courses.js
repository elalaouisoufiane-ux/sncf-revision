    ...
    "subchapters": [
      {
        ...
        "content": [
          ...
          {
            "type": "paragraph",
            "text": "Ce paragraphe montre le rendu du lecteur. Remplace-le par ton cours réel."
          },
          {
            "type": "callout",
            "kind": "important",
            "title": "Important",
            "text": "Encadré important prêt à accueillir un point essentiel."
          },
          {
            "type": "callout",
            "kind": "tip",
            "title": "Astuce",
            "text": "Encadré astuce pour une méthode, un moyen mnémotechnique ou une vigilance."
          },
          {
            "type": "table",
            "headers": [
            ...
            "rows": [
              [
                "Point clé",
                "Ajouter l'information validée."
              ],
              [
                "Référence",
                "Ajouter la source ou le support de cours."
              ]
            ]
          },
          {
          ...
          {
            "type": "note",
            "text": "Note personnelle ou précision à revoir."
          }
        ]
      }
    ]
    ...
    "subchapters": [
      {
        "id": "E-11-01",
        "chapterId": "E",
        "title": "E 11.01 - Sécurité du personnel : généralités",
        "description": "Objet, obligations, interdictions, règles qui sauvent et identification des risques.",
        "tags": [
          "02/07/2026",
          "E 11.01",
        ...
        "content": [
          ...
          },
          {
            ...
            "rows": [
              [
                ...
                "E 11.01",
                "1/2",
                "Sécurité du personnel : généralités"
              ],
              [
                "IMG_3540",
                "E 11.01",
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "E 11.01 - Sécurité du personnel : généralités"
          },
          {
            "type": "paragraph",
            "text": "Les prescriptions de prévention servent à réduire les risques professionnels qui ne peuvent pas être supprimés. Elles concernent les déplacements, le stationnement en milieu ferroviaire, les interventions liées à la conduite et la conduite à tenir en cas d'accident."
          },
          {
            "type": "list",
            "items": [
          ...
          {
            "type": "paragraph",
            "text": "Il est interdit de se déplacer ou de stationner dans une emprise ferroviaire non ouverte au public lorsque le service ne l'exige pas. Pour aller au travail ou rentrer chez soi, le conducteur utilise les chemins publics chaque fois que c'est possible."
          },
          {
            "type": "callout",
            "kind": "important",
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "E 11.01 - Identification des risques"
          },
          {
            "type": "list",
            "items": [
      ...
      },
      {
        "id": "E-11-02",
        "chapterId": "E",
        "title": "E 11.02 - Prescriptions concernant l'habillement",
        "description": "Mesures d'habillement pour stationner, se déplacer ou travailler sur les voies ou à leurs abords.",
        "tags": [
          "02/07/2026",
          "E 11.02",
          "habillement"
          ...
          },
          {
            ...
            "rows": [
              [
                ...
                "E 11.02",
                "1/2",
                "Prescriptions concernant l'habillement"
              ],
              [
                "IMG_3542",
                "E 11.02",
                "2/2",
                "Mesures d'habillement à appliquer"
              ]
            ]
          },
          {
            "type": "heading",
            "level": 2,
            "text": "E 11.02 - Prescriptions concernant l'habillement"
          },
          {
            "type": "paragraph",
            "text": "La tenue doit être fonctionnelle, adaptée aux risques ferroviaires et ne pas créer de danger supplémentaire. Les vêtements trop amples ou flottants peuvent s'accrocher à un véhicule ou à un organe en mouvement."
          },
          {
            "type": "list",
            "items": [
      ...
      },
      {
        "id": "E-11-03",
        "chapterId": "E",
        "title": "E 11.03 - Équipements de protection individuelle",
        "description": "Port, utilisation, contrôle et entretien des EPI, dont les gants isolants.",
        "tags": [
          "02/07/2026",
          "E 11.03",
          "EPI",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                ...
                "E 11.03",
                "2/2",
                "Utilisation des EPI et des gants isolants"
              ]
            ]
          },
          {
            "type": "heading",
            "level": 2,
            "text": "E 11.03 - Équipements de protection individuelle"
          },
          {
            "type": "paragraph",
            "text": "Les EPI servent à protéger contre les risques résiduels. Ils restent propriété de l'entreprise, sont remis au conducteur selon les besoins et doivent être utilisés uniquement dans les conditions prévues."
          },
          {
            "type": "list",
            "items": [
      ...
      },
      {
        "id": "E-12-01",
        "chapterId": "E",
        "title": "E 12.01 - Risque de heurt : généralités",
        "description": "Zone dangereuse, effet de souffle, garages, DATZD, DAELZD, DVN, PERS et conduite à tenir.",
        "tags": [
          "02/07/2026",
          "E 12.01",
          "risque de heurt",
        ...
        "content": [
          ...
          },
          {
            ...
            "rows": [
              [
                ...
                "E 12.01",
                "1/10",
                "Risque de heurt : généralités"
              ],
              [
                "IMG_3547",
                "E 12.01",
                "2/10",
                "Zone dangereuse, risques et emplacements de garage"
              ],
              [
                "IMG_3548",
                "E 12.01",
                "3/10",
                "Exemples de garages et garages réduits"
              ],
              [
                "IMG_3549",
                "E 12.01",
              ...
              [
                ...
                "E 12.01",
                "5/10",
                "Règles qui sauvent, accès et engagement de la ZD"
              ],
              [
                "IMG_3551",
                "E 12.01",
                "6/10",
                "Durée d’engagement et DVN"
              ],
              [
                "IMG_3552",
                "E 12.01",
                "7/10",
                "Tableaux de distance de visibilité nécessaire"
              ],
              [
                "IMG_3553",
                "E 12.01",
                "8/10",
                "Pistes soumises à procédure et demande PERS"
              ],
              [
                "IMG_3554",
                "E 12.01",
                "9/10",
                "Protection personnelle et mesures de déplacement"
              ],
              [
                "IMG_3555",
                "E 12.01",
                "10/10",
                "Conduite à tenir dans la zone dangereuse"
              ]
            ]
          },
          {
            "type": "heading",
            "level": 2,
            "text": "E 12.01 - Risque de heurt : généralités"
          },
          {
            "type": "paragraph",
            "text": "Se déplacer dans les installations ferroviaires demande une attention permanente. Les voies, les abords des voies et les zones proches des engins moteurs ne sont pas conçus comme des espaces publics ordinaires."
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            ...
            "headers": [
              "Vitesse de la voie",
              "Distance D de limite de zone dangereuse"
            ],
            "rows": [
              [
                "0 < V <= 40 km/h",
                "1,25 m, portée à 1,50 m en courbe"
              ],
              [
                "40 < V <= 160 km/h",
                "1,50 m"
              ...
              [
                "160 < V <= 200 km/h",
                "2,00 m, avec réduction possible signalée localement"
              ],
              [
                "200 < V <= 300 km/h",
                "2,00 m"
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Emplacements de garage"
          },
          {
            "type": "paragraph",
            "text": "Un emplacement de garage permet au conducteur, avec son matériel si nécessaire, de se tenir hors de la zone dangereuse pendant le passage d'une circulation."
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Dispositifs DATZD et DAELZD"
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Règles de déplacement dans les emprises"
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Durée d'engagement et DVN"
          },
          {
            "type": "paragraph",
            "text": "L'engagement dans la zone dangereuse doit rester exceptionnel. Il peut être transversal, pour traverser les voies, ou longitudinal, pour contourner un obstacle."
          },
          {
            "type": "table",
            "headers": [
              "Situation",
              "Délai de visibilité nécessaire"
            ],
            "rows": [
              [
                "Traversée de 1 ou 2 voies",
                "10 secondes"
              ],
              [
                "Traversée de 3 ou 4 voies",
                "15 secondes"
              ],
              [
                "Traversée de 5 ou 6 voies",
                "20 secondes"
              ],
              [
                "Obstacle longitudinal jusqu'à 5 m",
                "10 secondes"
              ],
              [
                "Obstacle longitudinal de plus de 5 m à 10 m",
                "15 secondes"
              ],
              [
                "Obstacle longitudinal de plus de 10 m à 15 m",
                "20 secondes"
              ]
            ]
          },
          ...
          {
            "type": "paragraph",
            "text": "Sur LGV, la traversée est interdite sauf mesures particulières de réduction de vitesse. La distance de visibilité nécessaire se détermine avec la vitesse maximale de la voie concernée."
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Pistes, procédures et protection personnelle"
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Entrer dans la zone dangereuse"
          },
          {
            "type": "list",
            "items": [
      ...
      },
      {
        ...
        "content": [
          ...
          },
          {
            ...
            "rows": [
              [
                ...
                "E 12.02",
                "1/5",
                "Principe des déplacements à pied, pistes et itinéraires"
              ],
              [
                "IMG_3559",
                "E 12.02",
                "2/5",
                "Schémas de pistes et itinéraires"
              ],
              [
                "IMG_3560",
                "E 12.02",
                "3/5",
                "Risques sur piste, quai, délais de visibilité et piste interrompue"
              ],
              [
                "IMG_3561",
                "E 12.02",
                "4/5",
                "VL supérieure à 160 km/h, LGV et situations pratiques"
              ],
              [
                "IMG_3562",
                "E 12.02",
                "5/5",
                "Circulation contiguë, anomalie, VL supérieure à 160 km/h et LGV"
              ]
            ]
          },
          {
          ...
          {
            "type": "paragraph",
            "text": "Tout déplacement à pied dans les emprises doit se faire calmement, sans précipitation et sans courir. Le conducteur doit garder sa perception visuelle et sonore disponible."
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Rester hors de la zone dangereuse"
          },
          {
            "type": "paragraph",
            "text": "Même hors de la zone dangereuse, le conducteur doit éviter d'être surpris par le souffle d'une circulation, une partie saillante ou un chargement déplacé."
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            ...
            "rows": [
              [
                "Distance à parcourir en ZD <= 5 m",
                "10 secondes"
              ],
              [
                "Distance à parcourir en ZD > 5 m et <= 10 m",
                "15 secondes"
              ],
              [
                "Distance à parcourir en ZD > 10 m et <= 15 m",
                "20 secondes"
              ],
              [
                "Distance à parcourir en ZD > 15 m",
                "Engagement longitudinal interdit sans mesures particulières"
              ],
              [
                "Traversée de 1 à 2 voies",
                "10 secondes"
              ],
              [
                "Traversée de 3 ou 4 voies",
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "VL supérieure à 160 km/h et LGV"
          },
          {
            "type": "list",
            "items": [
      ...
      },
      {
        ...
        "content": [
          ...
          },
          {
            ...
            "rows": [
              [
                ...
                "E 12.03",
                "1/6",
                "Risques de traversée et règles générales"
              ],
              [
                "IMG_3564",
                "E 12.03",
                "2/6",
                "Distances devant, derrière ou entre véhicules et passages planchéiés"
              ],
              [
                "IMG_3565",
                "E 12.03",
                "3/6",
                "Fonctionnement de la Traversée de Voie Publique"
              ],
              [
                "IMG_3566",
                "E 12.03",
                "4/6",
                "Mesures SGC et traversée d'une voie non occupée"
              ],
              [
                "IMG_3567",
                "E 12.03",
                "5/6",
                "Avant, pendant, après la traversée et cas de véhicules"
              ]
            ]
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Risques liés à la traversée"
          },
          {
            "type": "paragraph",
            "text": "Traverser une voie impose d'entrer dans la zone dangereuse. Le conducteur s'expose principalement au heurt par une circulation et à la chute sur un sol irrégulier ou glissant."
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            ...
            "rows": [
              [
                "Passer devant ou derrière un véhicule",
                "3 m de l'extrémité du véhicule"
              ],
              [
                "Passer entre deux véhicules immobilisés sur la même voie",
                "6,70 m au minimum"
              ],
              [
                "Établissement avec engins moteurs correctement immobilisés",
                "Distance de 3 m pouvant être réduite à 1,50 m"
              ]
            ]
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Passages planchéiés et TVP"
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Traverser une voie non occupée"
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Avant, pendant et après la traversée"
          },
          {
            "type": "list",
            "items": [
          ...
          },
          {
            "type": "heading",
            "level": 2,
            "text": "Voies occupées et véhicules en stationnement"
          },
          {
            "type": "list",
            "items": [
